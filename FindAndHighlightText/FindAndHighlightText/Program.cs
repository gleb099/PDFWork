...
namespace FindAndHighlightText
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (var pdf = new PdfDocument("C:/Users/shevchenko/Desktop/Рамочка/test2.pdf"))
            {
                const string TextToFind = "!?!?!?!qweq";
                //const StringComparison Comparison = StringComparison.InvariantCultureIgnoreCase;
                const StringComparison Comparison = StringComparison.CurrentCultureIgnoreCase;
                var highlightColor = new PdfRgbColor(255, 255, 0);

                highlightPhrases(pdf, TextToFind, Comparison, highlightColor, "Shevchenko");

                pdf.Save(pathToFile);
                ////!?!?-!?!?!qw
                //const string TextToFind2 = "qwertyqwertyqwertyqwertyqwertyqwertyqwertyqwerty";
                //const StringComparison Comparison2 = StringComparison.InvariantCultureIgnoreCase;
                //var highlightColor2 = new PdfRgbColor(255, 255, 255);

                //highlightPhrases(pdf, TextToFind2, Comparison2, highlightColor2, "General Glag 3");

                //pdf.Save(pathToFile);

                //const string TextToFind3 = "!?!?-!?!?!qw";
                //const StringComparison Comparison3 = StringComparison.InvariantCultureIgnoreCase;
                //var highlightColor3 = new PdfRgbColor(255, 255, 255);

                //highlightPhrases(pdf, TextToFind3, Comparison3, highlightColor3, "Seleznev");
        ...
        private static void highlightPhrases(PdfDocument pdf, string textToFind, StringComparison comparison,
            PdfColor highlightColor, string rename = "S")
        {
            ...
            foreach (PdfPage page in pdf.Pages)
            {
                foreach (PdfRectangle[] phraseBounds in findPhrases(page, wordsToFind, comparison))
                {
                    ...
                    //page.Canvas.Brush.Color = new PdfRgbColor(0, 0, 0);
                    //page.Canvas.DrawString(rename, phraseBounds[0], PdfTextAlign.Center, PdfVerticalAlign.Center);
                }
            }
        }
        ...
        private static void sortWords(List<PdfTextData> words, PdfMatrix transformation)
        {
            ...
            PdfPoint xAxis = transformVector(transformation, 0.1, 0);
            PdfPoint yAxis = transformVector(transformation, 0.1, 0.1);
